...
class Barrena extends StatefulWidget {
  const Barrena({super.key});

  @override
  _BarrenaState createState() => _BarrenaState();
}

class _BarrenaState extends State<Barrena> {
...
final List<Map<String, String>> steps = [
  {
    'text': 'Se introduce la barrena Uhland al suelo por impacto ',
    'image': 'https://docs.flutter.dev/assets/images/dash/dash-fainting.gif',
  },
  {
    'text':
        'La muestra que queda contenida en el cilindro se coloca en un bote de aluminio, ',
    'image': 'https://docs.flutter.dev/assets/images/dash/dash-fainting.gif',
  },
  {
    'text':
        'Se secará en la estufa a 1100C hasta tener un peso constante (PSS), lo cual suele ocurrir aproximadamente en 24 horas.',
    'image': 'https://docs.flutter.dev/assets/images/dash/dash-fainting.gif',
  },
  {
    'text':
